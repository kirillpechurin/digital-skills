...
from flask import Blueprint, request, flash, make_response, url_for, render_template, jsonify
...
from portfolio.internal.http.rest_api.answers.children_organisation import get_response_list_learners, \
    get_response_detail_learner
...
def main_page(auth_account_main_id: int, organisation_id: int):
    if request.method == 'GET':
        ...
        dict_for_detail_organisation = {
            "info_organisation": info_organisation,
            "list_employee": list_employee
        }

        return get_response_detail_organisation_employee(dict_for_detail_organisation)
...
def get_requests(auth_account_main_id: int, organisation_id: int):
    if request.method == 'GET':
        ...
        return get_response_list_requests(list_request_to_organisation)
...
def get_detail_request(auth_account_main_id: int, organisation_id: int, request_id: int):
    if request.method == 'GET':
        ...
        return get_response_detail_request(request_to_organisation)
...
def get_list_learners(auth_account_main_id: int, organisation_id: int):
    if request.method == 'GET':
        ...
        return get_response_list_learners(list_learners)
...
def get_detail_children(children_org_id: int, auth_account_main_id: int, organisation_id: int):
    if request.method == 'GET':
        ...
        dict_for_ser = {
            ...
            "list_achievement_for_completed_event": list_achievements_for_completed_events,
            "children_organisation": children_org
        }

        return get_response_detail_learner(dict_for_ser)
...
def get_list_events(auth_account_main_id: int, organisation_id: int):
    if request.method == 'GET':
        ...
        return get_response_list_events(list_events)
...
def detail_event(auth_account_main_id: int, organisation_id: int, events_id: int):
    if request.method == 'GET':
        ...
        return get_response_detail_events(dict_for_ser)
...
def calendar(auth_account_main_id: int, organisation_id: int):
    if request.method == 'GET':
        ...
        return get_response_detail_events_for_date(dict_for_ser)
